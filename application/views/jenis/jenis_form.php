...
<table class='table table-bordered>'        
	    ...
	    <tr><td width='200'>Quota <?php echo form_error('quota') ?></td><td><input type="text" class="form-control" name="quota" id="quota" placeholder="Quota" value="<?php echo $quota; ?>" /></td></tr>
	    ...
	    <a href="<?php echo site_url('jenis') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a></td></tr>
	</table></form>        </div>
</div>
</div>