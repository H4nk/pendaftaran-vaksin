            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
                ...
                <table class='table table-bordered>'>        
                    ...
                    ?>
                       ...
                       <tr><td width='200'>Alamat <?php echo form_error('alamat') ?></td><td><input type="text" class="form-control" name="alamat" id="alamat" placeholder="Alamat Lengkap" value="<?php echo $alamat; ?>" /></td></tr>
                       <tr><td width='200'>Nomor HP/WhatsApp <?php echo form_error('hp') ?></td><td><input type="text" class="form-control" name="hp" id="full_name" placeholder="Nomor Handphone yang aktif" value="<?php echo $hp; ?>" /></td></tr>
