<div class="content-wrapper">
    <section class="content">
            ...
            <div class="col-xs-12">
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">KELOLA DATA JADWAL</h3>
                    </div>
		...
		<th>Action</th>
			...
			<td><?php echo $this->Db_model->get_data($jadwal->vaksin,'nama','jenis') ?></td>
			<td><?php echo $jadwal->ket ?></td>
			<td><?php echo $jadwal->st ?></td>
			<td style="text-align:center" width="200px">
				<?php 

				echo anchor(site_url('jadwal/update/'.$jadwal->id),'<i class="fa fa-pencil-square-o" aria-hidden="true"></i>','class="btn btn-danger btn-sm"'); 
				echo '  '; 
